...
public class SubmissionsFragment extends Fragment {
    ...
    private void load_submissions_from_firebase(@NonNull DataSnapshot dataSnapshot) {
        for(DataSnapshot CHILDER: dataSnapshot.getChildren()){
            final Object rating = CHILDER.child("mysubmissions").child("drawingcomp").child("rating").getValue();
            if(CHILDER.child("mysubmissions").child("drawingcomp").child("rating").exists()){
                final Object submittersid = CHILDER.getKey();
                final Object ratings = CHILDER.child("mysubmissions").child("drawingcomp").child("ratings").getValue();
                final Object name = CHILDER.child("name").getValue();
                final Object imageoncloud = CHILDER.child("mysubmissions").child("drawingcomp").child("imageoncloud").getValue();
    ...
    private void fill_recyclerview() {
        if(getView()!=null) {
            ...
            submissionsAdapter = new SubmissionsAdapter(getContext(), Submissions);
