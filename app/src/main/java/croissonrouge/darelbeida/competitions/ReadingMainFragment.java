...
public class ReadingMainFragment extends Fragment {
    ...
    private void download_image(final Context context) {
        ...
        final StorageReference imagereference = storage.getReference().child("images").child("challenge2.jpg");
    ...
    private void variables(View view) {
        ...
        explanation.setText(getResources().getString(R.string.readingexplanation));
        title.setText(getResources().getString(R.string.readingtitle));
    }
    private void fonts() {
        if(getContext()!=null) {
    ...
    private boolean imageexistsinstorage() {
        ...
        String submissionpath = mysubmissionsfolderpath + "/" + "challenge2.jpg";
