...
import static croissonrouge.darelbeida.competitions.CookingSubmissionsFragment.*;


public class CookingSubmissionsAdapter extends RecyclerView.Adapter<CookingSubmissionsAdapter.ViewHolder> {
    ...
    CookingSubmissionsAdapter(Context context, List<submission> givensubmissions) {
    ...
    @NonNull
    @Override
    public CookingSubmissionsAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull final CookingSubmissionsAdapter.ViewHolder viewHolder, int position) {
        CookingSubmissionsFragment.submission iteme = submissions.get(position);
    ...
    private void setup_on_click_listeners(final Context context, ViewHolder viewHolder, final submission iteme, final List<submission> submissions, final int position, final String BOOKTITLE, final String RESUME) {
        viewHolder.rate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                CommunicationInterface3 callback= (CommunicationInterface3) context;
