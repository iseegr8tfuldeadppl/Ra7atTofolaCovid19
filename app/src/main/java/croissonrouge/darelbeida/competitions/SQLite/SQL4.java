...
public class SQL4 extends SQLiteOpenHelper {
    ...
    private static final String DATABASE_NAME = "croissonrougedarelbeida9.db"; //not case sensitive
    ...
    private static SQL4 mInstance = null;

    public SQL4(Context context) {
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        ...
        sqLiteDatabase.execSQL("CREATE TABLE IF NOT EXISTS " + TABLE_NAME + "(" + COL_1 + " INTEGER PRIMARY KEY AUTOINCREMENT, " + COL_21 + " TEXT, " + COL_22 + " TEXT,  " + COL_23 + " TEXT, " + COL_24 + " TEXT, " + COL_25 + " TEXT, " + COL_26 + " TEXT" + ");");
    }
    ...
    public static SQL4 getInstance(Context ctx) {

        if (mInstance == null) {
            mInstance = new SQL4(ctx.getApplicationContext());
        }
        return mInstance;
    }
    ...
    public boolean insertData(String _SUBMITTERSNAME, String _SUBMITTERSUID, String MYVOTEONHISPOST, String RATING, String RATINGS, String IMAGEINCLOUD){
    ...
    public boolean updateData(String _ID, String _SUBMITTERSNAME, String _SUBMITTERSUID, String MYVOTEONHISPOST, String RATING, String RATINGS, String IMAGEINCLOUD){
        SQLiteDatabase sqLiteDatabase = this.getWritableDatabase();
        ContentValues contentValues = new ContentValues();
