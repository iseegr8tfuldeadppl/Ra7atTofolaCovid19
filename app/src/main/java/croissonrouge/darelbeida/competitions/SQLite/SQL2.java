...
public class SQL2 extends SQLiteOpenHelper {
    ...
    private static final String DATABASE_NAME = "croissonrougedarelbeida2.db"; //not case sensitive
    ...
    private static SQL2 mInstance = null;
    ...
    public static SQL2 getInstance(Context ctx) {

        if (mInstance == null) {
            mInstance = new SQL2(ctx.getApplicationContext());
        }
        return mInstance;
    }
