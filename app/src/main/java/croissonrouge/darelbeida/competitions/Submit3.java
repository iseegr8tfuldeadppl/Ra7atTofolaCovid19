...
public class Submit3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try{
            ...
            firebase();
            sql();
            SQLSharing.mycursor.moveToPosition(5);
        ...
        if(getIntent()!=null){
            ...
            if(sender!=null){
                if(sender.equals("MAIN")){
                    ...
                    Intent onviewsomebodys = new Intent(this, ViewSomeonesSubmission3.class);
                                ...
                                .addOnSuccessListener(
                                        new OnSuccessListener<UploadTask.TaskSnapshot>() {
                                            ...
                                            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                                                ...
                                                final DatabaseReference userRef = database.getReference("users").child(uid).child("mysubmissions").child("cookingcomp");
