...
public class ViewSomeonesSubmission3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_someones_submission3);
    ...
    private void getsubmissionsfromsql() {
        ...
        while(SQLSharing.mycursor4.moveToNext()){
            Submissions.add(new SubmissionsFragment.submission() {{
                SUBMITTERSNAME = SQLSharing.mycursor4.getString(1);
                SUBMITTERSUID = SQLSharing.mycursor4.getString(2);
                MYVOTEONHISPOST = Integer.parseInt(SQLSharing.mycursor4.getString(3));
                RATING = Integer.parseInt(SQLSharing.mycursor4.getString(4));
                RATINGS = Integer.parseInt(SQLSharing.mycursor4.getString(5));
                IMAGEONCLOUD = SQLSharing.mycursor4.getString(6);
            }});
        }
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent back = new Intent(this, CookingSubmissions.class);
        startActivity(back);
        finish();
    }
    ...
    private void updatefirebase() {
        if(uid!=null){
            ...
            database.getReference("users").child(SUBMITTERSUID).child("mysubmissions").child("cookingcomp").child("ratings").setValue(String.valueOf(RATINGS));
            database.getReference("users").child(SUBMITTERSUID).child("mysubmissions").child("cookingcomp").child("rating").setValue(String.valueOf(RATING));
